...
?>
<div class="wrap">
  <form class="am-form am-form-horizontal" method="post" action="<?php echo esc_url(WW_Module::ww_manage_get_url('update_enquiry', $_SESSION['center_id'], $_SESSION['enq_id']));?>">
    <fieldset>
