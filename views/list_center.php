  ...
  echo '<div class="wrap">';
    echo '<table class="am-table am-table-hover">';
      ...
      echo '<tr>'.
            ...
            '<td>'.$piece->phone.'</td>'.
            '<td>'.$piece->address.'</td>'.
            '<td><a href='.esc_url(WW_Module::ww_manage_get_url('show_add')).'>EDIT</a> | <a href='.esc_url(WW_Module::ww_manage_get_url('del_center', 'center_id' = $piece -> center_id)).'>DELETE</a></td>'.
            '</tr>';
      }
    echo  '</table>';
  echo '</div>';
